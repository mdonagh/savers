    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.container}>
        ...
        <ScrollView style={styles.scroll} contentContainerStyle={styles.scrollContent}>
          ...
          <Text style={styles.p}>
            Quik$avers, LLC and its affiliated companies (collectively,“Company” or “we” or “us” or “our”) respects the privacy of its customers (“user” or “you”) that use our Quik$avers App and the www.Quik$avers.com website, as well as any other media form or media channel related or connected thereto (collectively, the “App and Website”).   The following Company privacy policy (“Privacy Policy”) is designed to inform you, as a user of the App and Website, about the types of information that Company may gather about or collect from you in connection with your use of the App and Website. It also is intended to explain the conditions under which Company uses and discloses that information, and your rights in relation to that information. Changes to this Privacy Policy are discussed at the end of this document. Each time you use the App and Website, however, the current version of this Privacy Policy will apply. Accordingly, each time you use the App and Website you should check the date of this Privacy Policy (which appears at the beginning of this document) and review any changes since the last time you used the App and Website.
          </Text>
          <Text style={styles.p}>
            The App and Website is hosted in the United States of America and is subject to U.S. state and federal law. If you are accessing our App and Website from other jurisdictions, please be advised that you are transferring your personal information to us in the United States, and by using our App and Website, you consent to that transfer and use of your personal information in accordance with this Privacy Policy. You also agree to abide by the applicable laws of applicable states and U.S. federal law concerning your use of the App and Website and your agreements with us. Any persons accessing our App and Website from any jurisdiction with laws or regulations governing the use of the Internet, including personal data collection, use and disclosure, different from those of the jurisdictions mentioned above may only use the App and Website in a manner lawful in their jurisdiction. If your use of the App and Website would be unlawful in your jurisdiction, please do not use the App and Website.
          </Text>
          <Text style={styles.p}>
            BY USING OR ACCESSING THE APP AND WEBSITE, YOU ARE ACCEPTING THE PRACTICES DESCRIBED IN THIS PRIVACY POLICY.
          </Text>
          <Text style={styles.label}>GATHERING, USE AND DISCLOSURE OF NON-PERSONALLY-IDENTIFYING INFORMATION</Text>
          <Text style={styles.label}>Users of the App and Website Generally</Text>
          <Text style={styles.p}>
            “Non-Personally-Identifying Information” is information that, without the aid of additional information, cannot be directly associated with a specific person. “Personally-Identifying Information,” by contrast, is information such as a name or email address that, without more, can be directly associated with a specific person. Like most App and Website operators, Company gathers from users of the App and Website Non-Personally-Identifying Information of the sort that Web browsers, depending on their settings, may make available. That information includes the user’s Internet Protocol (IP) address, operating system, browser type and the locations of the websites the user views right before arriving at, while navigating and immediately after leaving the App and Website. Although such information is not Personally-Identifying Information, it may be possible for Company to determine from an IP address a user’s Internet service provider and the geographic location of the visitor’s point of connectivity as well as other statistical usage data. Company analyzes Non-Personally-Identifying Information gathered from users of the App and Website to help Company better understand how the App and Website is being used. By identifying patterns and trends in usage, Company is able to better design the App and Website to improve users’ experiences, both in terms of content and ease of use. From time to time, Company may also release the Non-Personally-Identifying Information gathered from App and Website users in the aggregate, such as by publishing a report on trends in the usage of the App and Website.
          </Text>
          <Text style={styles.label}>Web Cookies</Text>
          <Text style={styles.p}>
            A “Web Cookie” is a string of information which assigns you a unique identification that a website stores on a user’s computer, and that the user’s browser provides to the website each time the user submits a query to the website. We use cookies on the App and Website to keep track of services you have used, to record registration information regarding your login name and password, to record your user preferences, to keep you logged into the App and Website and to facilitate purchase procedures. Company also uses Web Cookies to track the pages that users visit during each App and Website session, both to help Company improve users’ experiences and to help Company understand how the App and Website is being used. As with other Non-Personally-Identifying Information gathered from users of the App and Website, Company analyzes and discloses in aggregated form information gathered using Web Cookies, so as to help Company, its partners and others better understand how the App and Website is being used. COMPANY USERS WHO DO NOT WISH TO HAVE WEB COOKIES PLACED ON THEIR COMPUTERS SHOULD SET THEIR BROWSERS TO REFUSE WEB COOKIES BEFORE ACCESSING THE APP AND WEBSITE, WITH THE UNDERSTANDING THAT CERTAIN FEATURES OF THE APP AND WEBSITE MAY NOT FUNCTION PROPERLY WITHOUT THE AID OF WEB COOKIES. APP AND WEBSITE USERS WHO REFUSE WEB COOKIES ASSUME ALL RESPONSIBILITY FOR ANY RESULTING LOSS OF FUNCTIONALITY.
          </Text>
          <Text style={styles.label}>Third-Party Advertisers</Text>
          <Text style={styles.p}>
            We may use third-party advertising companies to serve ads when you visit the App and Website. These companies may use information (not including any Personally-Identifying Information) about your visits to the App and Website and other websites that are contained in Web Cookies in order to provide advertisements about goods and services of interest to you. Using a tool created by the Network Advertising Initiative, you can opt out of several third-party ad servers’ and networks’ Web Cookies simultaneously. If you would like more information about this practice and to know your choices about not having this information used by these companies, please follow the following links: http://networkadvertising.org/managing/opt_out.asp, http://preferences-mgr.truste.com/ or http://www.aboutads.info/choices/. Please contact us if you would like to know the identity of the third-party advertising companies we are currently using to serve ads.
          </Text>
          <Text style={styles.p}>
          ...
          <Text style={styles.label}>Web Beacons</Text>
            <Text style={styles.p}>
              A “Web Beacon” is an object that is embedded in a web page or email that is usually invisible to the user and allows website operators to check whether a user has viewed a particular web page or an email. Company may use Web Beacons on the App and Website and in emails to count users who have visited particular pages, viewed emails and to deliver co-branded services. Web Beacons are not used to access users’ Personally-Identifying Information. They are a technique Company may use to compile aggregated statistics about App and Website usage. Web Beacons collect only a limited set of information, including a Web Cookie number, time and date of a page or email view and a description of the page or email on which the Web Beacon resides. You may not decline Web Beacons. However, they can be rendered ineffective by declining all Web Cookies or modifying your browser setting to notify you each time a Web Cookie is tendered, permitting you to accept or decline Web Cookies on an individual basis.  
            </Text>
            <Text style={styles.label}>Analytics</Text>
            <Text style={styles.p}>
              We may partner with selected third parties to allow tracking technology on the App and Website, which will enable them to collect data about how you interact with the App and Website and our services over time. This information may be used to, among other things, analyze and track data, determine the popularity of certain content and better understand online activity.
            </Text>
            <Text style={styles.label}>Aggregated and Non-Personally-Identifying Information</Text>
            <Text style={styles.p}>
              We may share aggregated and Non-Personally Identifying Information we collect under any of the above circumstances. We may also share it with third parties and our affiliate companies to develop and deliver targeted advertising on the App and Website and on websites of third parties. We may combine Non-Personally Identifying Information we collect with additional Non-Personally Identifying Information collected from other sources. We also may share aggregated information with third parties, including advisors, advertisers and investors, for the purpose of conducting general business analysis. For example, we may tell our advertisers the number of visitors to the App and Website and the most popular features or services accessed. This information does not contain any Personally-Identifying Information and may be used to develop App and Website content and services that we hope you and other users will find of interest and to target content and advertising.
            </Text>
            <Text style={styles.label}>Mobile Device Additional Terms</Text>
              <Text style={styles.p}>
                •  Mobile Device. If you use a mobile device to access the App and Website or download any of our applications, we may collect device information (such as your mobile device ID, model and manufacturer), operating system, version information and IP address.
              </Text>
              <Text style={styles.p}>
              ...
              <Text style={styles.p}>
                We may use hyperlinks on the App and Website which will redirect you to a social network if you click on the respective link. However, when you click on a social plug-in, such as Facebook’s “Like” button, Twitter’s “tweet” button or the Google+, that particular social network’s plugin will be activated and your browser will directly connect to that provider’s servers. If you do not use these buttons, none of your data will be sent to the respective social network’s plugin provider. So for example, when you click on the Facebook’s “Like” button on the App and Website, Facebook will receive your IP address, the browser version and screen resolution, and the operating system of the device you have used to access the App and Website. Settings regarding privacy protection can be found on the websites of these social networks and are not within our control.
              </Text>
              <Text style={styles.label}>COLLECTION, USE AND DISCLOSURE OF PERSONALLY-IDENTIFYING INFORMATION</Text>
                <Text style={styles.label}>App and Website Registration</Text>
                <Text style={styles.p}> 
                  As defined above, Personally-Identifying Information is information that can be directly associated with a specific person. Company may collect a range of Personally-Identifying Information from and about App and Website users. Much of the Personally-Identifying Information collected by Company about users is information provided by users themselves when (1) registering for our service, (2) logging in with social network credentials, (3) participating in polls, contests, surveys or other features of our service, or responding to offers or advertisements, (4) communicating with us, (5) creating a public profile or (6) signing up to receive newsletters. That information may include each user’s name, address, email address and telephone number, and, if you transact business with us, financial information such as your payment method (valid credit card number, type, expiration date or other financial information). We also may request information about your interests and activities, your gender, age, date of birth, username, hometown and other demographic or relevant information as determined by Company from time to time. Users of the App and Website are under no obligation to provide Company with Personally-Identifying Information of any kind, with the caveat that a user’s refusal to do so may prevent the user from using certain App and Website features.
                </Text>
                <Text style={styles.p}> 
                  BY REGISTERING WITH OR USING THE APP AND WEBSITE, YOU CONSENT TO THE USE AND DISCLOSURE OF YOUR PERSONALLY-IDENTIFYING INFORMATION AS DESCRIBED IN THIS “COLLECTION, USE AND DISCLOSURE OF PERSONALLY-IDENTIFYING INFORMATION” SECTION.
                </Text>
                <Text style={styles.label}>Company Communications</Text>
                <Text style={styles.p}>
                ...
                <Text style={styles.label}>Company Disclosures</Text>
                <Text style={styles.p}>
